...
class Order < ApplicationRecord
  ...
  def search_payment
    ...
    $mp.get("/v1/payments/#{payment_id}")
  end

  # payment statuses, more descriptive payment status
  def update_mp_status
    update(
      mp_response: mp_statuses[payment_status][payment_status_detail]
    )
  end
